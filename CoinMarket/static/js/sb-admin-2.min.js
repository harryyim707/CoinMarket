...
!function (l) {
    ...
    l("#sidebarToggle, #sidebarToggleTop").on("click", function (e) {
        l("body").toggleClass("sidebar-toggled"), l(".sidebar").toggleClass("toggled"),l("#sidebarCard").toggleClass("toggled"), l(".sidebar").hasClass("toggled") && l(".sidebar .collapse").collapse("hide"), l("#sidebarCard").hasClass("toggled") ? l('#sidebarCard').removeClass('d-lg-flex'):l('#sidebarCard').addClass('d-lg-flex'), l(".sidebar").hasClass("toggled")? l(".sidebar").children('li.nav-item').find('span').hide() : l(".sidebar").children('li.nav-item').find('span').show()
